...
if __name__ == "__main__":
	...
	parser.add_argument('--variable_updates', metavar='<LIST_OF_VARIABLE_UPDATES>', type=str, required=True, 
		help='string of variable_update methods, e.g. "parameter_server,replicated,distributed_replicated"')
	parser.add_argument('--models', metavar='<LIST_OF_MODELS>', type=str, required=True, 
	...
	parser.add_argument('--num_gpus', type=int, required=False, metavar='n_GPUs',
                help='number of GPUs')
	parser.add_argument('--all_reduce_spec', type=str, required=False, metavar='SPEC',
	...
	# if server_protocol='grpc+verbs', RDMA_DEVICE must be specified(e.g. RDMA_DEVICE=mlx5_3).
